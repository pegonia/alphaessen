...
try {
    ...
    if ($essenCount == 0) {
        $beispielEssen = [
            ['name' => 'Hähnchen-Curry', 'typ' => 'Hauptgericht_Fleisch', 'beschreibung' => 'Mit Reis und Gemüse'],
            ['name' => 'Gemüse-Curry', 'typ' => 'Hauptgericht_Vegetarisch', 'beschreibung' => 'Mit Kichererbsen und Reis'],
            ['name' => 'Linseneintopf', 'typ' => 'Hauptgericht_Vegetarisch', 'beschreibung' => 'Herzhaft mit Gemüse'],
    ...
    if ($adminCount == 0) {
        ...
        $adminPasswort = 'alphaessen2024'; // Standardpasswort - bitte ändern!
